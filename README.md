...
1. Поля "Фамилия"/"Имя":
  а. Невалидные класс эквивалентности  > 250                                      | "Ошибка регистрации"
  б. Валидный класс                    <= 250                                     |  "Успех"
  в. Граничные значения:               1,249,250,251                                     

2. Поле "мобильный телефон" 
 а. Невалидные классы эквивалентности    < 10 цифр(9), > 10 цифр(11)                | "Ошибка регистрации"
 б. Валидный класс эквивалентности       = 10цифр                                   |  "Успех"   
 в. Граничные значения:                  9,10,11
  ...
  Проверка на ввод уже существующего в системе номера
